 ...
 * -----
 * 
 * osuarezqwixxduel.action.php
 *
 * osuarezqwixxduel main action entry point
 *
 *
 ...
 */
  ...
  class action_osuarezqwixxduel extends APP_GameAction
  { 
    // Constructor: please do not modify
   	public function __default()
  	{
  	    ...
  	    {
            $this->view = "osuarezqwixxduel_osuarezqwixxduel";
